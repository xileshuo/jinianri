...
\u516C\u7248\u4E0E 24 \u5C0F\u65F6\u4F53\u9A8C\u7248\u9996\u6B21\u5B89\u88C5 **\u9884\u586B 3 \u6761\u793A\u4F8B\u7EAA\u5FF5\u4E8B\u9879**\uFF08\u751F\u65E5 / \u7EAA\u5FF5\u65E5 / \u604B\u7231\u7EAA\u5FF5\uFF09\uFF0C\u5E76\u975E\u7A7A\u5217\u8868\uFF0C\u53EF\u7F16\u8F91\u6216\u5220\u9664\u540E\u6DFB\u52A0\u81EA\u5DF1\u7684\u3002\u4E2A\u4EBA\u7248\u5185\u7F6E\u4E2A\u4EBA\u7EAA\u5FF5\u4E8B\u9879\u3002
...
function getEditionLabel() {
  if (isTrialEdition()) return "24\u5C0F\u65F6\u4F53\u9A8C\u7248";
...
function renderEditionBadge(parent) {
  ...
  parent.createSpan({
    ...
    text: label,
    attr: {
      title: isTrialEdition() ? "24 \u5C0F\u65F6\u5168\u529F\u80FD\u8BD5\u7528" : isLicenseEnforced() ? "\u9700\u6FC0\u6D3B\u540E\u4F7F\u7528\u5168\u90E8\u529F\u80FD" : "\u5DF2\u5185\u7F6E\u6388\u6743\uFF0C\u53EF\u76F4\u63A5\u4F7F\u7528"
    }
  });
}
...
var LIFEOS_UI_STYLE_ID = "lifeos-ui-shared-styles-v12";
...
function injectLifeOsSharedStyles() {
  ...
  for (const legacyId of [
    ...
    (_a = document.getElementById(legacyId)) == null ? void 0 : _a.remove();
  }
...
function getEnabledLifeOsPlugins(app) {
  ...
  return LIFEOS_PLUGIN_CATALOG.filter((p) => {
    const inst = plugins[p.id] || (p.id === "braincore-lifeos" ? plugins["braincore-dashboard"] : null);
...
function renderLifeOsAboutPanel(panel, plugin, options = {}) {
  ...
  LIFEOS_PLUGIN_CATALOG.forEach((item) => {
    ...
    const installed = !!(((_b = (_a = plugin.app.plugins) == null ? void 0 : _a.plugins) == null ? void 0 : _b[item.id]) || item.id === "braincore-lifeos" && ((_d = (_c = plugin.app.plugins) == null ? void 0 : _c.plugins) == null ? void 0 : _d["braincore-dashboard"]));
    if (item.id === selfId) {
...
var MOBILE_STYLE_ID = "jnr-settings-mobile-styles-v15";
...
// src/settings-tab.ts
var JinianriSettingTab = class extends import_obsidian14.PluginSettingTab {
  constructor(app, plugin) {
    super(app, plugin);
    this.plugin = plugin;
  }
  ...
  renderLicensePanel(panel) {
    renderLifeOsLicenseSettingsPanel(panel, {
      ...
      onCopyFingerprint: async (fp) => {
        const ok = await copyTextToClipboard(fp);
        new import_obsidian14.Notice(ok ? "\u8BBE\u5907\u6307\u7EB9\u5DF2\u590D\u5236" : "\u8BF7\u624B\u52A8\u5168\u9009\u590D\u5236\u6307\u7EB9");
      },
      onActivate: async (key) => {
        const wasActivated = this.plugin.settings.licenseActivated;
        if (!key) {
          new import_obsidian14.Notice("\u8BF7\u8F93\u5165\u6FC0\u6D3B\u7801");
          return;
        }
        ...
        if (this.plugin.settings.licenseActivated) {
          new import_obsidian14.Notice("\u6FC0\u6D3B\u6210\u529F\uFF0C\u4E4B\u540E\u5C06\u6C38\u4E45\u6709\u6548");
        } else {
          new import_obsidian14.Notice("\u6FC0\u6D3B\u7801\u65E0\u6548\uFF0C\u8BF7\u6838\u5BF9\u540E\u518D\u8BD5");
  ...
  renderReminderPanel(panel) {
    ...
    this.plugin.settings.reminderTiers.forEach((tier, index) => {
      var _a;
      const labels = ["A", "B", "C"];
      new import_obsidian14.Setting(card).setName(`\u6863\u4F4D ${(_a = labels[index]) != null ? _a : index + 1}`).addText((text) => {
    ...
    new import_obsidian14.Setting(card).setName("\u5E93\u5185\u5F39\u7A97").addToggle(
    ...
    if (import_obsidian14.Platform.isMobile) {
      ...
      new import_obsidian14.Setting(card).setName("\u7CFB\u7EDF\u901A\u77E5").setDesc("\u4EC5\u684C\u9762\u7AEF\u6709\u6548").addToggle(
      ...
      if (import_obsidian14.Platform.isMacOS) {
        card.createEl("p", {
          cls: "jnr-settings-section-hint",
    ...
    new import_obsidian14.Setting(card).setName("\u7D2F\u8BA1\u9879\u4E5F\u63D0\u9192\u5468\u5E74").setDesc("\u300C\u5728\u4E00\u8D77\u300D\u8FD9\u7C7B\u7D2F\u8BA1\u5929\u6570\u4E8B\u9879\u9ED8\u8BA4\u4E0D\u53D1\u5468\u5E74\u63D0\u9192").addToggle(
    ...
    new import_obsidian14.Setting(card).setName("\u6BCF\u65E5\u65F6\u95F4").addText((text) => {
    ...
    new import_obsidian14.Setting(card).setName("\u6D4B\u8BD5\u63D0\u9192").setDesc("\u53EA\u6D4B\u5F39\u7A97\u6E20\u9053\uFF0C\u4E0D\u8D70\u6BCF\u65E5\u65F6\u95F4\u548C\u6863\u4F4D").addButton(
      (btn) => btn.setButtonText("\u53D1\u9001\u6D4B\u8BD5").onClick(() => this.plugin.sendTestReminder())
    );
    new import_obsidian14.Setting(card).setName("\u518D\u5F39\u4ECA\u5929").setDesc("\u4ECA\u5929\u5DF2\u7ECF\u8BB0\u4E3A\u63D0\u9192\u8FC7\u3001\u4F46\u6CA1\u770B\u5230\u5F39\u7A97\u65F6\u7528\uFF08\u5F39\u7A97\u5E38\u88AB\u8BBE\u7F6E\u9875\u6321\u4F4F\uFF09").addButton(
    ...
    for (const groupId of this.plugin.getGroupOrder()) {
      ...
      groupHead.createEl("button", { text: "\u5220\u9664\u5206\u7EC4", cls: "jnr-text-btn mod-warning" }).addEventListener("click", () => {
        if (this.plugin.settings.groups.length <= 1) {
          new import_obsidian14.Notice("\u81F3\u5C11\u4FDD\u7559\u4E00\u4E2A\u5206\u7EC4");
          return;
        }
  ...
  renderGeneralPanel(panel) {
    ...
    new import_obsidian14.Setting(card).setName("\u72B6\u6001\u680F").addToggle(
    ...
    new import_obsidian14.Setting(card).setName("2 \u6708 29 \u65E5").setDesc("\u9633\u5386 2/29 \u7684\u7EAA\u5FF5\u65E5\u5728\u975E\u95F0\u5E74\u843D\u5728\u54EA\u5929").addDropdown((dd) => {
    ...
    new import_obsidian14.Setting(card).setName("\u5D4C\u5165\u4EE3\u7801").addButton(
      (btn) => btn.setButtonText("\u590D\u5236").onClick(async () => {
        const ok = await copyTextToClipboard("```jinianri\n```");
        new import_obsidian14.Notice(ok ? "\u2705 \u5DF2\u590D\u5236\u5D4C\u5165\u4EE3\u7801" : "\u590D\u5236\u5931\u8D25\uFF0C\u8BF7\u624B\u52A8\u8F93\u5165 ```jinianri```");
      })
    );
    card.createEl("p", {
      cls: "jnr-settings-section-hint",
  ...
  renderDataPanel(panel) {
    ...
    new import_obsidian14.Setting(card).setName("data.json").setClass("jnr-settings-action-row").addButton(
...
${settingsPath}`
    ...
    new import_obsidian14.Setting(card).setName("events.json").setClass("jnr-settings-action-row").addButton(
...
\u6B64\u64CD\u4F5C\u4E0D\u53EF\u64A4\u9500\uFF0C\u662F\u5426\u7EE7\u7EED\uFF1F`;
  ...
  async openSettingsFile() {
    ...
    new import_obsidian14.Notice(`\u8BBE\u7F6E\u6587\u4EF6\uFF1A${path}`);
  }
  ...
  renderEventRow(list, event, index) {
    ...
    const saveName = () => {
      if (!iconInput.value.trim() && !labelInput.value.trim()) {
        new import_obsidian14.Notice("\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A\uFF0C\u5DF2\u4FDD\u7559\u539F\u6765\u7684\u540D\u79F0");
...
var ReminderAlertModal = class extends import_obsidian15.Modal {
...
function showDesktopNotification(title, body) {
  if (!import_obsidian16.Platform.isDesktopApp) return false;
  try {
...
function showReminderNotices(entries, options = {}) {
  ...
  if (desktop && import_obsidian16.Platform.isDesktopApp) {
  ...
  if (!shown) {
    new import_obsidian16.Notice("\u8BF7\u5148\u5F00\u542F\u300C\u5E93\u5185\u5F39\u7A97\u300D\u6216\u300C\u7CFB\u7EDF\u901A\u77E5\u300D", 5e3);
  }
  return shown;
}
...
function buildTestReminderMessage(pluginName = "\u7EAA\u5FF5\u65E5") {
  const channel = import_obsidian17.Platform.isMobile ? "Obsidian \u5185\u5F39\u7A97" : "Obsidian \u5185\u5F39\u7A97 + \u684C\u9762\u7CFB\u7EDF\u901A\u77E5\uFF08\u5982\u5DF2\u5F00\u542F\uFF09";
  return {
    title: "\u{1F382} \u6D4B\u8BD5\u63D0\u9192",
...
var ReminderService = class {
  ...
  checkReminders(force = false) {
    ...
    const desktop = settings.enableDesktopNotification && import_obsidian18.Platform.isDesktopApp;
    if (!obsidian && !desktop) {
      if (this.noChannelNoticeDay !== today) {
        this.noChannelNoticeDay = today;
        new import_obsidian18.Notice("\u8BF7\u5148\u5F00\u542F\u300C\u5E93\u5185\u5F39\u7A97\u300D\u6216\u300C\u7CFB\u7EDF\u901A\u77E5\u300D", 5e3);
      }
      return;
    }
...
var DataStore = class {
  ...
  async load() {
    ...
    for (const legacy of LEGACY_VAULT_DATA_FILES) {
      const legacyPath = (0, import_obsidian19.normalizePath)(legacy);
  ...
  async readEventsFile(path) {
    ...
    const exists = this.plugin.app.vault.getAbstractFileByPath(path) instanceof import_obsidian19.TFile || await adapter.exists(path);
    if (!exists) return { status: "missing" };
    const backupCorrupt = async (raw) => {
      const stamp = (/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-");
      const backupPath = (0, import_obsidian19.normalizePath)(`${path}.corrupt-${stamp}.bak`);
      try {
        await adapter.write(backupPath, raw);
        new import_obsidian19.Notice(`events.json \u5DF2\u635F\u574F\uFF0C\u5DF2\u5907\u4EFD\u4E3A ${backupPath.split("/").pop()}\uFF0C\u672A\u8986\u76D6\u539F\u6587\u4EF6`);
      } catch (e) {
        new import_obsidian19.Notice("events.json \u5DF2\u635F\u574F\uFF0C\u5907\u4EFD\u5931\u8D25\uFF1B\u539F\u6587\u4EF6\u672A\u6539\u52A8\uFF0C\u8BF7\u624B\u52A8\u68C0\u67E5");
      }
    };
    const file = this.plugin.app.vault.getAbstractFileByPath(path);
    try {
      const raw = file instanceof import_obsidian19.TFile ? await this.plugin.app.vault.read(file) : await adapter.read(path);
      let parsed;
      try {
      ...
      new import_obsidian19.Notice("\u7EAA\u5FF5\u65E5\u6570\u636E\u8BFB\u53D6\u5931\u8D25\uFF0C\u8BF7\u5728\u8BBE\u7F6E \u2192 \u6570\u636E \u2192 events.json \u68C0\u67E5\u6587\u4EF6\u683C\u5F0F");
      return { status: "corrupt" };
    }
  }
  async save(events) {
  ...
  async writeEvents(path, eventsOrContent) {
    ...
    if (folder) {
      await this.plugin.app.vault.adapter.mkdir((0, import_obsidian19.normalizePath)(folder)).catch(() => {
      });
    }
    ...
    try {
      ...
      new import_obsidian19.Notice(`\u4FDD\u5B58\u5931\u8D25\uFF1A${err instanceof Error ? err.message : String(err)}`);
      throw err;
    }
  }
  async importFromMarkdown(notify = true) {
    const file = this.plugin.app.vault.getAbstractFileByPath((0, import_obsidian19.normalizePath)(MD_SOURCE));
    if (!(file instanceof import_obsidian19.TFile)) {
      if (notify) new import_obsidian19.Notice(`\u672A\u627E\u5230 ${MD_SOURCE}`);
      return [];
    }
    const content = await this.plugin.app.vault.read(file);
    const events = parseMarkdownAnniversaries(content);
    if (events.length === 0 && notify) {
      new import_obsidian19.Notice("\u672A\u80FD\u4ECE \u7EAA\u5FF5\u65E5.md \u89E3\u6790\u5230\u6570\u636E");
    }
    return events;
  }
...
\u6B64\u64CD\u4F5C\u4E0D\u53EF\u64A4\u9500\uFF0C\u662F\u5426\u7EE7\u7EED\uFF1F`,
    ...
    this.plugin.refreshAll();
    new import_obsidian19.Notice(`\u5DF2\u4ECE \u7EAA\u5FF5\u65E5.md \u5BFC\u5165 ${events.length} \u6761\u7EAA\u5FF5\u4E8B\u9879`);
  ...
  async openEventsFile() {
    ...
    new import_obsidian19.Notice(`\u6570\u636E\u6587\u4EF6\uFF1A${path}
\uFF08\u4F4D\u4E8E\u63D2\u4EF6\u76EE\u5F55\uFF0C\u53EF\u7528\u6587\u4EF6\u7BA1\u7406\u5668\u6253\u5F00\uFF09`);
  }
...
var JinianriStatusBar = class {
  constructor(plugin) {
    this.el = null;
    this.plugin = plugin;
    if (import_obsidian20.Platform.isMobile) return;
...
async function exportIcsToVault(app, events, getComputed, _settings, icsPath) {
  const path = (0, import_obsidian21.normalizePath)(icsPath != null ? icsPath : getPluginIcsPath(app));
  const content = buildIcsContent(events, getComputed, _settings);
  const folder = path.split("/").slice(0, -1).join("/");
  if (folder) await app.vault.adapter.mkdir((0, import_obsidian21.normalizePath)(folder)).catch(() => {
  });
...
function showIcsExportNotice(path) {
  let hint;
  if (import_obsidian21.Platform.isMacOS) {
    hint = "macOS\uFF1A\u5728\u300C\u65E5\u5386\u300D\u2192 \u6587\u4EF6 \u2192 \u5BFC\u5165\uFF0C\u6216\u53CC\u51FB .ics \u6587\u4EF6";
  } else if (import_obsidian21.Platform.isMobile) {
    hint = "\u53EF\u5C06 .ics \u6587\u4EF6\u5206\u4EAB\u5230\u7CFB\u7EDF\u65E5\u5386 App";
  } else {
    hint = "\u53EF\u7528\u7CFB\u7EDF\u65E5\u5386\u6216 Outlook \u7B49\u5E94\u7528\u5BFC\u5165 .ics \u6587\u4EF6";
  }
  new import_obsidian21.Notice(`\u5DF2\u5BFC\u51FA ${path}
${hint}`, 1e4);
}
...
function showUpdateNoticeModal(app, plugin, options) {
  try {
    ...
    const modal = new import_obsidian22.Modal(app);
    ...
    try {
      new import_obsidian22.Notice("\u65E0\u6CD5\u6253\u5F00\u66F4\u65B0\u65E5\u5FD7\uFF0C\u8BF7\u91CD\u8BD5\u6216\u91CD\u542F Obsidian");
    } catch (e) {
    }
  }
}
...
var JinianriPlugin = class extends import_obsidian23.Plugin {
  ...
  renderInlineDashboard(container, source = "") {
    ...
    const paint = () => {
      ...
      const compact = opts.forceCompact === true || opts.forceCompact !== false && (import_obsidian23.Platform.isMobile || width > 0 && width < 480);
      container.empty();
      container.addClass("jnr-inline-dashboard");
