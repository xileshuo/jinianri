...
function normalizeEvent(raw) {
  ...
  return {
    ...
    notes: raw.notes,
    isSample: raw.isSample === true ? true : void 0
  };
}
...
function findNextSolarForLunarMD(lunarMonth, lunarDay, minDate, leapMonth = false) {
  ...
  for (let i = 0; i <= span; i++) {
    const found = lunarOccurrenceInYear(baseYear + i, lunarMonth, lunarDay, leapMonth);
...
function getNextOccurrence(event, from = /* @__PURE__ */ new Date()) {
  ...
  let candidate = solarOccurrenceInYear(today.getFullYear(), origin.month, origin.day);
  if (candidate < today) {
    candidate = solarOccurrenceInYear(today.getFullYear() + 1, origin.month, origin.day);
  }
  return candidate;
}
...
function getLastOccurrence(event, now = /* @__PURE__ */ new Date()) {
  ...
  let candidate = solarOccurrenceInYear(today.getFullYear(), parts.month, parts.day);
  if (candidate > today) {
    candidate = solarOccurrenceInYear(today.getFullYear() - 1, parts.month, parts.day);
  }
...
// src/license.ts
function getPluginEdition() {
  const raw = typeof PLUGIN_EDITION !== "undefined" ? String(PLUGIN_EDITION) : "";
  if (raw === "public" || raw === "personal") return raw;
  return null;
}
function isPublicEdition() {
  const edition = getPluginEdition();
  if (edition) return edition === "public";
...
function renderEditionBadge(parent) {
  ...
  parent.createSpan({
    ...
    text: label,
    attr: { title: `${label} \xB7 ${getEditionBadgeHint()}` }
  });
}
function getEditionBadgeHint() {
  if (isTrialEdition()) return `${getTrialHoursLabel()}\u5168\u529F\u80FD\u8BD5\u7528`;
  if (isPublicEdition()) {
    return isLicenseEnforced() ? "\u9700\u6FC0\u6D3B\u540E\u4F7F\u7528\u5168\u90E8\u529F\u80FD" : "\u65E0\u9700\u6FC0\u6D3B\u7801\uFF0C\u88C5\u597D\u5373\u53EF\u4F7F\u7528";
  }
  return "\u5DF2\u5185\u7F6E\u6388\u6743\uFF0C\u53EF\u76F4\u63A5\u4F7F\u7528";
}
...
var LIFEOS_RELEASE = "2026.08.26";
var LIFEOS_UI_STYLE_ID = "lifeos-ui-shared-styles-v10";
...
var USAGE_GUIDE_VERSION = "2026-08-25-jinianri-guide-v18";
...
**\u4E2A\u4EBA\u7248** / **\u516C\u7248** / **\u4F53\u9A8C\u7248** \u6807\u8BC6\u4F1A\u663E\u793A\u5728\uFF1A\u7535\u8111\u7AEF\u8BBE\u7F6E\u9875\u6807\u9898\uFF08\u542B\u7248\u672C\u53F7\uFF0C\u5982\u300C\u7EAA\u5FF5\u65E5 \u914D\u7F6E \xB7 \u4E2A\u4EBA\u7248 v4.0.0\u300D\uFF09\u3001\u79FB\u52A8\u7AEF\u5168\u5C4F\u770B\u677F\u9876\u680F\u5FBD\u7AE0\u3002
...
> | 48\u5C0F\u65F6\u4F53\u9A8C\u7248 | \u4F53\u9A8C\u7248 | 3 \u6761\u793A\u4F8B | \u8BD5\u7528\u671F\u5185\u4E0D\u9700\u8981\uFF0C\u5230\u671F\u540E\u9700\u8981 |
>
...
\u7B2C\u4E00\u6B21\u6253\u5F00\u4FA7\u8FB9\u680F\u65F6\uFF0C\u82E5\u5C1A\u672A\u6FC0\u6D3B\uFF08\u516C\u7248\uFF08\u5546\uFF09\u6216\u4F53\u9A8C\u7248\u5230\u671F\u540E\uFF09\uFF0C\u4F1A\u8FDB\u5165 **\u521D\u59CB\u5316\u5411\u5BFC**\u3002\u4E2A\u4EBA\u7248\u4E0E\u516C\u7248\uFF08\u514D\u6FC0\u6D3B\uFF09\u65E0\u9700\u6FC0\u6D3B\uFF0C\u88C5\u597D\u542F\u7528\u5373\u53EF\u76F4\u63A5\u4F7F\u7528\uFF0C\u4E0D\u4F1A\u770B\u5230\u672C\u8282\u5185\u5BB9\u3002
...
> \u4E24\u79CD\u516C\u7248\u4E0E\u4F53\u9A8C\u7248\u9996\u6B21\u5B89\u88C5\u90FD\u9884\u586B 3 \u6761\u793A\u4F8B\uFF08\u540D\u79F0\u90FD\u5E26\u300C\u793A\u4F8B\u300D\uFF09\uFF0C\u53EF\u76F4\u63A5\u7F16\u8F91\u6210\u81EA\u5DF1\u7684\u7EAA\u5FF5\u65E5\uFF0C\u4E5F\u53EF\u4EE5\u5728\u4FA7\u8FB9\u680F\u63D0\u793A\u6761\u6216 **\u8BBE\u7F6E \u2192 \u4E8B\u9879 \u2192 \u6E05\u9664\u793A\u4F8B** \u4E00\u952E\u5220\u6389\u3002\u4ECD\u517C\u5BB9\u65E7\u7248\u6309\u5E93\u540D\u751F\u6210\u7684\u6FC0\u6D3B\u7801\u3002

---

## \u4E94\u3001\u4FA7\u8FB9\u680F\u4F7F\u7528\u8BF4\u660E

\u4FA7\u8FB9\u680F\u7528\u4E8E **\u6D4F\u89C8 + \u5FEB\u901F\u7F16\u8F91\u5355\u6761**\uFF1B\u6279\u91CF\u4FEE\u6539\u3001\u5206\u7EC4\u7BA1\u7406\u3001\u5BFC\u5165\u5BFC\u51FA\u5728\u8BBE\u7F6E\u9875\u3002**\u5217\u8868\u89C6\u56FE**\u5E95\u90E8\u63D0\u793A **\u70B9\u51FB\u6298\u53E0 \xB7 \u62D6\u52A8\u6392\u5E8F \xB7 \u70B9\u51FB\u4E8B\u9879\u76F4\u63A5\u7F16\u8F91**\uFF0C\u4E0B\u65B9\u4E24\u884C **\u8FDB\u5165 Obsidian \u8BBE\u7F6E \u2192 \u7EAA\u5FF5\u65E5 \u2192 \u4E8B\u9879** / **\u53EF\u6279\u91CF\u4FEE\u6539\u3001\u5206\u7EC4\u7BA1\u7406\u4E0E\u5BFC\u5165\u5BFC\u51FA**\uFF08\u6708\u5386\u3001\u65F6\u95F4\u8F74\u4E0D\u663E\u793A\u8BE5\u63D0\u793A\uFF1B\u79FB\u52A8\u7AEF\u9996\u6B21\u8FDB\u5165\u5217\u8868\u4F1A\u5F39 Notice\uFF09\u3002
...
\u8BBE\u7F6E\u9875\u91C7\u7528 **\u6807\u7B7E\u9875 + \u5361\u7247\u533A\u5757** \u5E03\u5C40\uFF08BrainCore \u98CE\u683C\uFF09\u3002\u672A\u6FC0\u6D3B\u7684\u516C\u7248\uFF08\u5546\uFF09\u4E0E\u5230\u671F\u7684\u4F53\u9A8C\u7248\uFF0C\u4EC5 **\u6388\u6743 \xB7 \u6570\u636E \xB7 \u5173\u4E8E** \u53EF\u7528\u3002
...
1. \u5386\u6CD5\u9009 **\u{1F3EE} \u9634\u5386**\uFF0C\u70B9\u65E5\u671F\u6309\u94AE\u6253\u5F00\u8F6E\u76D8
2. \u6708\u4EFD\u8F6E\u76D8\u5728\u8BE5\u5E74\u6709\u95F0\u6708\u65F6\u4F1A\u591A\u51FA\u4E00\u9879 **\u95F0\xD7\u6708**\uFF08\u5982\u300C\u95F0\u4E8C\u6708\u300D\uFF09
3. \u95F0\u6708\u751F\u65E5\u8BF7\u9009 **\u5E26\u300C\u95F0\u300D** \u7684\u90A3\u4E00\u9879\uFF1B\u666E\u901A\u6708\u9009\u4E0D\u5E26\u300C\u95F0\u300D\u7684

\u9009\u4E2D\u95F0\u6708\u540E\uFF0C\u65E5\u671F\u6309\u94AE\u4E0E\u5361\u7247\u4FE1\u606F\u4F1A\u6807\u6CE8\u300C\u95F0\xD7\u6708\u300D\uFF0C\u4E0E\u666E\u901A\u6708\u5206\u5F00\u8BA1\u7B97\uFF0C\u4E0D\u4F1A\u4E92\u76F8\u9519\u914D\u3002
...
**\u516C\u7248\uFF08\u5546\uFF09\u3001\u516C\u7248\uFF08\u514D\u6FC0\u6D3B\uFF09\u4E0E 48 \u5C0F\u65F6\u4F53\u9A8C\u7248** \u9996\u6B21\u5B89\u88C5\u90FD **\u9884\u586B 3 \u6761\u793A\u4F8B\u7EAA\u5FF5\u4E8B\u9879**\uFF08\u751F\u65E5 / \u7EAA\u5FF5\u65E5 / \u604B\u7231\u7EAA\u5FF5\uFF09\uFF0C\u540D\u79F0\u90FD\u5E26\u300C\u793A\u4F8B\u300D\uFF0C\u5E76\u975E\u4F60\u81EA\u5DF1\u7684\u6570\u636E \u2014\u2014 \u4E24\u79CD\u516C\u7248\u5728\u8FD9\u4E00\u70B9\u4E0A\u5B8C\u5168\u76F8\u540C\u3002
...
function maybeShowLifeOsSuitePrompt(app, selfId, selfName) {
  const peers = getEnabledLifeOsPlugins(app).filter((p) => p.id !== selfId).map((p) => p.name);
...
async function startTrialFromActivationPanel(plugin) {
  ...
  (_a = plugin.reminderService) == null ? void 0 : _a.start();
  plugin.refreshViews();
}
  ...
  renderLifeOsActivationPanel(container, {
    ...
    onActivate: async (key, msgEl) => {
      if (!key) {
        ...
        new import_obsidian4.Notice("\u8BF7\u8F93\u5165\u6FC0\u6D3B\u7801");
        return;
      }
...
function getSidebarInteractionHint(touchPreferred) {
  ...
  return touch ? "\u8F7B\u70B9\u6298\u53E0\u2022\u62D6\u52A8\u6392\u5E8F\u2022\u8F7B\u70B9\u4E8B\u9879\u76F4\u63A5\u7F16\u8F91" : "\u70B9\u51FB\u6298\u53E0\u2022\u62D6\u52A8\u6392\u5E8F\u2022\u70B9\u51FB\u4E8B\u9879\u76F4\u63A5\u7F16\u8F91";
}
...
var SAMPLE_EVENTS = [
  {
    ...
    isSample: true,
    notes: "\u8FD9\u662F\u63D2\u4EF6\u9884\u586B\u7684\u793A\u4F8B\uFF0C\u53EF\u76F4\u63A5\u7F16\u8F91\u6210\u4F60\u81EA\u5DF1\u7684\u7EAA\u5FF5\u65E5\uFF0C\u6216\u4E00\u952E\u6E05\u9664\u5168\u90E8\u793A\u4F8B"
  },
  {
...
var DashboardPanel = class {
  ...
  renderSpotlightCard(parent, item) {
    ...
    const emphasize = item.isToday || item.daysUntil <= this.plugin.getSoonDaysThreshold();
    const card = parent.createDiv({
      cls: `jnr-spotlight-card${item.isToday ? " is-today" : ""}${emphasize ? " jnr-enter-emphasis" : ""}`,
  ...
  renderTimelineView(listEl, items) {
    ...
    const soonDays = this.plugin.getSoonDaysThreshold();
    for (const item of items) {
      const emphasize = item.isToday || item.daysUntil <= soonDays;
      const row = track.createDiv({
        cls: `jnr-timeline-item${item.isToday ? " is-today" : ""}${emphasize ? " jnr-enter-emphasis" : ""}`,
        attr: { role: "button", tabindex: "0" }
      });
  ...
  renderCard(parent, item, soonDays, draggable = true) {
    ...
    if (item.isToday || item.daysUntil <= soonDays) card.addClass("jnr-enter-emphasis");
...
function isMobileAppContext(app) {
  return app.isMobile || import_obsidian8.Platform.isMobileApp;
}
...
var MobileDashboardModal = class extends import_obsidian9.Modal {
  constructor(app, plugin) {
    super(app);
    /** main.ts 靠它判断「手机全屏面板是否开着」，决定要不要刷新与是否复用实例 */
    this.isOpen = false;
    this.panel = null;
    this.plugin = plugin;
  }
...
function parseYmd2(ymd, leapMonth) {
...
function daysInValueMonth(v, type) {
  if (type !== "lunar") return solarDaysInMonth(v.year, v.month);
  const count = getLunarMonthDayCount(v.year, v.month, v.leapMonth);
...
var DateWheelModal = class extends import_obsidian10.Modal {
  ...
  submit() {
    ...
    if (this.value.day > max) {
      const where = this.type === "lunar" ? `\u519C\u5386 ${this.value.year} \u5E74${lunarMonthLabel(this.value.month, this.value.leapMonth)}` : `${this.value.year} \u5E74 ${this.value.month} \u6708`;
      new import_obsidian10.Notice(`${where}\u53EA\u6709 ${max} \u5929\uFF0C\u8BF7\u91CD\u65B0\u9009\u62E9\u65E5\u671F`);
      return;
    }
    this.onConfirm({
      date: formatYmd2(this.value),
      leapMonth: this.type === "lunar" && this.value.leapMonth
    });
    this.close();
  }
  previewText() {
    ...
    return `${base}\uFF08${lunarMonthLabel(this.value.month, this.value.leapMonth)}\uFF09`;
  }
  monthWheelValue() {
...
function attachDateWheelButton(app, btn, options) {
  btn.addClass("jnr-date-btn");
  const refresh = () => {
    var _a, _b, _c;
    const type = (_b = (_a = options.getType) == null ? void 0 : _a.call(options)) != null ? _b : "solar";
    btn.setText(formatDateButtonLabel(options.getDate(), type, (_c = options.getLeapMonth) == null ? void 0 : _c.call(options)));
  };
  refresh();
...
var EventModal = class extends import_obsidian12.Modal {
  ...
  onOpen() {
    ...
    contentEl.createDiv({
      cls: "jnr-event-submit-hint",
      text: "\u2318/Ctrl + Enter \u4FDD\u5B58 \xB7 Esc \u53D6\u6D88"
    });
  ...
  submit() {
    const name = combineEventName(this.iconValue, this.labelValue).trim();
    if (!this.labelValue.trim()) {
      new import_obsidian12.Notice("\u8BF7\u5148\u586B\u5199\u7EAA\u5FF5\u4E8B\u9879\u540D\u79F0");
      const input = this.contentEl.querySelector(".jnr-event-label-input");
      input == null ? void 0 : input.focus();
      return;
    }
    if (!this.event.date) {
      new import_obsidian12.Notice("\u8BF7\u5148\u9009\u62E9\u65E5\u671F");
      return;
    }
...
function getPluginSettingsPath(app) {
  return (0, import_obsidian13.normalizePath)(`${app.vault.configDir}/plugins/${PLUGIN_ID}/data.json`);
}
function getPluginEventsPath(app) {
  return (0, import_obsidian13.normalizePath)(`${app.vault.configDir}/plugins/${PLUGIN_ID}/events.json`);
}
function getLegacyCombinedDataPath(app) {
  return getPluginSettingsPath(app);
}
function getPluginIcsPath(app) {
  return (0, import_obsidian13.normalizePath)(`${app.vault.configDir}/plugins/${PLUGIN_ID}/data.ics`);
}
...
var JinianriSettingTab = class extends import_obsidian15.PluginSettingTab {
  ...
  renderReminderPanel(panel) {
    ...
    const card = this.createBlock(
      grid,
      "\u63D0\u9192",
      "\u6BCF\u5929\u5728\u8BBE\u5B9A\u65F6\u95F4\u5F00\u59CB\u68C0\u67E5\uFF1B\u9519\u8FC7\u5F53\u5929\u4E4B\u540E\u6253\u5F00\u4F1A\u6309\u300C\u8FD8\u5269\u51E0\u5929\u300D\u8865\u53D1\uFF0C\u53EA\u53D1\u6700\u7D27\u7684\u90A3\u4E00\u6863\u3002\u5F53\u5929\u540E\u52A0\u7684\u4E8B\u9879\u8FC7\u4E86\u8BBE\u5B9A\u65F6\u95F4\u4E5F\u4F1A\u63D0\u9192\u3002\u4FA7\u8FB9\u680F\u300C\u5373\u5C06\u5230\u671F\u300D\u533A\u4E0E\u5DF2\u542F\u7528\u7684\u6700\u5927\u63D0\u9192\u6863\u4F4D\u8054\u52A8\uFF08\u81F3\u5C11 7 \u5929\uFF09\u3002"
    );
    ...
    new import_obsidian15.Setting(card).setName("\u6BCF\u65E5\u65F6\u95F4").addText((text) => {
      ...
      const apply = async (value) => {
        ...
        if (!this.plugin.setReminderTime(value)) {
          new import_obsidian15.Notice(`\u65F6\u95F4\u6CA1\u8BB0\u4F4F\uFF0C\u4ECD\u662F ${this.plugin.getReminderTimeString()}\u3002\u8BF7\u518D\u9009\u4E00\u6B21\u3002`);
          text.setValue(this.plugin.getReminderTimeString());
          return;
        }
        ...
        new import_obsidian15.Notice(`\u63D0\u9192\u65F6\u95F4\u5DF2\u6539\u4E3A ${t}\u3002\u5F53\u5929\u7684\u7EAA\u5FF5\u65E5\u5230\u70B9\u4F1A\u5F39\u7A97\uFF0C\u4E0D\u5360\u7528 30 / 15 / 7 \u6863\u3002`);
      };
      text.onChange((value) => void apply(value));
      text.inputEl.addEventListener("change", () => void apply(text.inputEl.value));
    });
    card.createEl("p", {
      cls: "jnr-settings-section-hint",
  ...
  renderOnboarding(parent) {
    ...
    const sampleCount = countSampleEvents(events);
    const onlySamples = events.length === 0 || isSampleOnlyData(events);
    const box = parent.createDiv({ cls: "jnr-onboarding" });
    box.createEl("h4", { text: onlySamples ? "\u5F00\u59CB\u4F7F\u7528" : "\u793A\u4F8B\u6570\u636E" });
    if (events.length === 0) {
      box.createEl("p", { text: "\u8FD8\u6CA1\u6709\u7EAA\u5FF5\u4E8B\u9879\uFF0C\u4F60\u53EF\u4EE5\uFF1A" });
    } else if (isSampleOnlyData(events)) {
      box.createEl("p", {
        text: `\u5F53\u524D ${sampleCount} \u6761\u90FD\u662F\u63D2\u4EF6\u9884\u586B\u7684\u793A\u4F8B\uFF0C\u4E0D\u662F\u4F60\u7684\u6570\u636E\u3002\u53EF\u4EE5\u76F4\u63A5\u7F16\u8F91\u6210\u81EA\u5DF1\u7684\u7EAA\u5FF5\u65E5\uFF0C\u6216\u4E00\u952E\u6E05\u9664\u540E\u91CD\u65B0\u6DFB\u52A0\u3002`
      });
    } else if (sampleCount > 0) {
      box.createEl("p", {
        text: `\u5E93\u91CC\u8FD8\u7559\u7740 ${sampleCount} \u6761\u63D2\u4EF6\u9884\u586B\u7684\u793A\u4F8B\uFF0C\u53EF\u4E00\u952E\u6E05\u9664\uFF0C\u4F60\u81EA\u5DF1\u6DFB\u52A0\u7684\u4E0D\u53D7\u5F71\u54CD\u3002`
      });
    }
    ...
    if (sampleCount > 0) {
      actions.createEl("button", { text: "\u6E05\u9664\u793A\u4F8B", cls: "jnr-text-btn mod-warning" }).addEventListener("click", () => void this.confirmClearSamples(sampleCount));
    }
  }
  async confirmClearSamples(count) {
    const ok = await showConfirm(this.app, {
      title: "\u6E05\u9664\u793A\u4F8B\u6570\u636E",
      message: `\u5C06\u5220\u9664 ${count} \u6761\u63D2\u4EF6\u9884\u586B\u7684\u793A\u4F8B\u7EAA\u5FF5\u4E8B\u9879\uFF0C\u4F60\u81EA\u5DF1\u6DFB\u52A0\u7684\u4E0D\u53D7\u5F71\u54CD\u3002`,
      confirmText: "\u6E05\u9664",
      warning: true
    });
    if (!ok) return;
    await this.plugin.clearSampleEvents();
    this.display();
  }
  renderEventsPanel(panel) {
    ...
    const card = this.createBlock(
      grid,
      "\u7EAA\u5FF5\u4E8B\u9879",
      "\u8FD9\u91CC\u9002\u5408\u6279\u91CF\u4FEE\u6539\uFF1A\u8868\u683C\u5185\u53EF\u5FEB\u901F\u6539 emoji + \u540D\u79F0 / \u65E5\u671F / \u5386\u6CD5 / \u5F00\u5173\uFF0C\u70B9 \u270F\uFE0F \u6253\u5F00\u5B8C\u6574\u7F16\u8F91\uFF08\u5907\u6CE8\u3001\u5206\u7EC4\u7B49\uFF09\u3002\u4FA7\u8FB9\u680F\u70B9\u67D0\u6761\u4E8B\u9879\u4F1A\u76F4\u63A5\u6253\u5F00\u5B83\u7684\u7F16\u8F91\u5F39\u7A97\u3002\u9634\u5386\u95F0\u6708\u8BF7\u5728\u65E5\u671F\u8F6E\u76D8\u9009\u5E26\u300C\u95F0\u300D\u7684\u6708\u4EFD\u3002"
    );
    ...
    if (this.plugin.events.length === 0 || countSampleEvents(this.plugin.events) > 0) {
  ...
  renderGeneralPanel(panel) {
    ...
    new import_obsidian15.Setting(card).setName("2 \u6708 29 \u65E5").setDesc("\u9633\u5386 2/29 \u7684\u7EAA\u5FF5\u65E5\u5728\u975E\u95F0\u5E74\u843D\u5728\u54EA\u5929").addDropdown((dd) => {
      ...
      dd.setValue(this.plugin.settings.leapDayFallback === "mar1" ? "mar1" : "feb28");
    ...
    card.createEl("p", {
      cls: "jnr-settings-section-hint",
      text: "\u4E2D\u6587\u4E60\u60EF\u591A\u6309 2 \u6708 28 \u65E5\u8FC7\uFF1B\u9009 3 \u6708 1 \u65E5\u5219\u987A\u5EF6\u5230\u4E0B\u4E00\u5929\u3002\u519C\u5386\u95F0\u6708\u751F\u65E5\u8BF7\u5728\u65E5\u671F\u8F6E\u76D8\u9009\u5E26\u300C\u95F0\u300D\u7684\u6708\u4EFD\u3002"
    });
...
var ReminderAlertModal = class extends import_obsidian16.Modal {
  ...
  onOpen() {
    ...
    host.style.setProperty("z-index", "1000200", "important");
    modalEl.style.setProperty("z-index", "1000200", "important");
    contentEl.empty();
    ...
    for (const entry of this.entries) {
      ...
      if (multiple) {
        group.createEl("h3", { cls: "jnr-reminder-alert-subtitle", text: entry.title });
      }
...
function buildTierReminderMessage(item, tier) {
  ...
  const body = [
    ...
    `\u4E0B\u6B21\uFF1A${formatYmd(item.nextDate)}\uFF08${eventCalendarLabel(item.event)} ${item.event.date}\uFF09`,
...
function buildTodayReminderMessage(item) {
  ...
  const body = [
    "\u{1F389} \u5C31\u662F\u4ECA\u5929\uFF01\u7EAA\u5FF5\u65E5\u5FEB\u4E50\uFF01",
    `${eventCalendarLabel(item.event)} ${item.event.date} \xB7 ${formatPassedLabel(item)}`
  ].join("\n");
  return { title, body };
}
function buildTestReminderMessage(pluginName = "\u7EAA\u5FF5\u65E5") {
  const channel = import_obsidian18.Platform.isMobile ? "\u5E93\u5185\u5F39\u7A97" : "\u5E93\u5185\u5F39\u7A97 + \u7CFB\u7EDF\u901A\u77E5\uFF08\u5982\u5DF2\u5F00\u542F\uFF09";
  return {
    title: "\u{1F382} \u6D4B\u8BD5\u63D0\u9192",
...
var ReminderService = class {
  ...
  checkReminders(force = false) {
    ...
    if (pending.length === 0) {
      ...
      if (this.hasTodayAlreadySent(today) && this.alreadySentHintDay !== today) {
        ...
        new import_obsidian19.Notice("\u4ECA\u5929\u7684\u7EAA\u5FF5\u65E5\u5DF2\u7ECF\u63D0\u9192\u8FC7\u4E86\u3002\u82E5\u5F53\u65F6\u6CA1\u770B\u5230\u5F39\u7A97\uFF08\u5E38\u88AB\u8BBE\u7F6E\u9875\u6321\u4F4F\uFF09\uFF0C\u8BF7\u5230\u8BBE\u7F6E \u2192 \u63D0\u9192\u70B9\u300C\u518D\u5F39\u4ECA\u5929\u300D\u3002", 8e3);
      }
      return;
    }
    ...
    if (!shown) return;
    void this.markRemindersSent(pending.map((p) => p.key), today);
  }
  /**
  ...
  hasTodayAlreadySent(today) {
    ...
    return this.plugin.settings.sentReminderKeys.some((key) => key.endsWith(suffix));
  }
...
var JinianriStatusBar = class {
  ...
  update() {
    ...
    const yearly = items.filter((i) => !i.isElapsed);
    const todayItems = yearly.filter((i) => i.isToday);
    ...
    const nearest = (_a = yearly[0]) != null ? _a : items[0];
...
var LUNAR_EXPAND_YEARS = 30;
function hasLunarEvents(events) {
  return events.some((e) => e.type === "lunar");
}
...
function buildIcsContent(events, getComputed, settings) {
  ...
  if (hasLunarEvents(events)) {
    lines.push(
      `X-WR-CALDESC:${escapeIcs(
        `\u519C\u5386\u4E8B\u9879\u65E0\u6CD5\u7528\u91CD\u590D\u89C4\u5219\u8868\u8FBE\uFF0C\u5DF2\u9010\u5E74\u5C55\u5F00 ${LUNAR_EXPAND_YEARS} \u5E74\uFF1B\u5EFA\u8BAE\u6BCF\u5E74\u91CD\u65B0\u5BFC\u51FA\u4E00\u6B21\u3002`
      )}`
    );
  }
  ...
  for (const event of events) {
    ...
    const appendEvent = (occurrence, uidSuffix, withYearly = false, withCountdown = true) => {
      ...
      const calLabel = event.type === "lunar" ? event.leapMonth ? "\u9634\u5386\u95F0\u6708" : "\u9634\u5386" : "\u9633\u5386";
      const descParts = [`${calLabel} ${event.date}`];
      if (withCountdown) {
        const daysUntil = Math.round(
          (startOfDay3(occurrence).getTime() - startOfDay3(/* @__PURE__ */ new Date()).getTime()) / 864e5
        );
        descParts.push(daysUntil === 0 ? "\u5C31\u662F\u4ECA\u5929" : `\u8FD8\u6709 ${daysUntil} \u5929`);
      }
      if (event.type === "lunar") {
        descParts.push(`\u519C\u5386\u4E3A\u9010\u5E74\u5C55\u5F00\uFF08\u7EA6 ${LUNAR_EXPAND_YEARS} \u5E74\uFF09\uFF0C\u5230\u671F\u8BF7\u91CD\u65B0\u5BFC\u51FA`);
      }
    ...
    if (event.type === "lunar") {
      let ref = startOfDay3(/* @__PURE__ */ new Date());
      const untilYear = ref.getFullYear() + LUNAR_EXPAND_YEARS;
      for (let i = 0; i < LUNAR_EXPAND_YEARS; i += 1) {
        const occurrence = getNextOccurrence(event, ref);
        if (occurrence.getFullYear() > untilYear) break;
        appendEvent(occurrence, formatIcsDate(occurrence), false, i === 0);
        ref = new Date(
...
function showIcsExportNotice(path, withLunar = false) {
  let hint;
  ...
  const lines = [`\u5DF2\u5BFC\u51FA ${path}`, hint];
  if (withLunar) {
    lines.push(
      `\u519C\u5386\u4E8B\u9879\u65E0\u6CD5\u7528\u91CD\u590D\u89C4\u5219\u8868\u8FBE\uFF0C\u5DF2\u9010\u5E74\u5C55\u5F00 ${LUNAR_EXPAND_YEARS} \u5E74\uFF1B\u5EFA\u8BAE\u6BCF\u5E74\u91CD\u65B0\u5BFC\u51FA\u4E00\u6B21\u3002`
    );
  }
  new import_obsidian22.Notice(lines.join("\n"), withLunar ? 14e3 : 1e4);
}
...
var JinianriPlugin = class extends import_obsidian23.Plugin {
  ...
  async bootstrap() {
    ...
    try {
      ...
      this.codeBlockProcessor = safeRegisterCodeBlockProcessor(
        this,
        "jinianri",
        // 首参是代码块源码，容器元素是第二个；漏接一个参数会把字符串当容器用
        (_source, el) => this.renderInlineDashboard(el)
      );
  ...
  setReminderTime(value) {
    ...
    this.settings.reminderHour = parsed.hour;
    this.settings.reminderMinute = parsed.minute;
    return true;
  }
  sendTestReminder() {
  ...
  openEditEventModal(eventId) {
    ...
    if (!event) {
      new import_obsidian23.Notice("\u8BE5\u7EAA\u5FF5\u4E8B\u9879\u5DF2\u4E0D\u5B58\u5728");
      return;
    }
  ...
  async clearSampleEvents() {
    ...
    if (removed === 0) {
      new import_obsidian23.Notice("\u6CA1\u6709\u793A\u4F8B\u6570\u636E\u53EF\u6E05\u9664");
      return 0;
    }
    this.events = this.events.filter((e) => !isSampleEvent(e));
    await this.flushSaveEvents();
    new import_obsidian23.Notice(`\u5DF2\u6E05\u9664 ${removed} \u6761\u793A\u4F8B\u6570\u636E`);
    return removed;
  }
  isLicensed() {
  ...
  async flushSaveEvents() {
    ...
    window.setTimeout(() => {
      var _a;
      return (_a = this.reminderService) == null ? void 0 : _a.checkReminders();
    }, 450);
  }
  async reloadEvents() {
    this.invalidateComputeCache();
  ...
  async exportIcal() {
    ...
    try {
      ...
      showIcsExportNotice(file.path, hasLunarEvents(this.events));
  ...
  renderInlineDashboard(container) {
    ...
    if (!this.isLicensed()) {
      ...
      renderLifeOsEmptyState(container, {
        icon: "\u{1F512}",
        message: "\u5D4C\u5165\u770B\u677F\u9700\u8981\u5148\u6FC0\u6D3B\u63D2\u4EF6\u3002",
        ctaLabel: "\u53BB\u6FC0\u6D3B",
        onCta: () => void this.activateSidebar()
      });
      return;
    }
    container.empty();
    ...
    if (items.length === 0) {
      renderLifeOsEmptyState(container, {
        icon: "\u{1F4C5}",
        message: "\u8FD8\u6CA1\u6709\u53EF\u5C55\u793A\u7684\u7EAA\u5FF5\u4E8B\u9879\u3002\u6DFB\u4E00\u6761\uFF0C\u8FD9\u91CC\u5C31\u4F1A\u663E\u793A\u5012\u8BA1\u65F6\u8868\u683C\u3002",
        ctaLabel: "+ \u6DFB\u52A0",
        onCta: () => this.openAddEventModal()
      });
      return;
    }
